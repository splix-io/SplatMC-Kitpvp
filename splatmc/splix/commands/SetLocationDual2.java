...
public class SetLocationDual2 implements CommandExecutor {
	
	private Main plugin;
	public SetLocationDual2(Main plugin) {
		this.plugin = plugin;
	...
	public boolean onCommand(CommandSender sender, org.bukkit.command.Command cmd, String label, String[] args) {
		...
		if (p.hasPermission("Splatmc.Staff")) {
			...
			Config.set("Dual.Dual1.x2", (int) x);
			Config.set("Dual.Dual1.y2", (int) y);
			Config.set("Dual.Dual1.z2", (int) z);
